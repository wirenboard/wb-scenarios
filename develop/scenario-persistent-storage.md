...
По этому ключу `scenario-init-main.js` собирает список устройств, топики
которых нужно удалить перед созданием сценариев. Ключ пишется для любого
сценария — и описанного в конфиге, и созданного из правила `wb-rules`.
