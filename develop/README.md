...
1) В начале в любом сценарии должны всегда идти 4 стандартные поля
   ...
   - `id_prefix` - данное поле используется для уникального префикса
     правил, виртуальных устройств и тд. В данный момент вводится
     пользователем, но планируется убрать его и создавать имена
     автоматически транслитом с добавлением какой-либо соли.
