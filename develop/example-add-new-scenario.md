...
Разработка нового сценария состоит из четырёх этапов (подробнее см. [development-process.md](development-process.md)):
...
3. **Объединение схемы и логики** — создаём модуль инициализации, подключаем в main
4. **Тестирование** — проверяем полный цикл работы сценария
...
## Этап 3. Объединение схемы и логики
...
### 4.1. Выбор контролов для проверки
