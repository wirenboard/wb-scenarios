...
Разработка нового сценария состоит из шести этапов (подробнее см. [development-process.md](development-process.md)):

0. **Подготовительный этап** - сбор требований (в примере пропущен)
