...
Плагин может быть разработан для двух полезных действий:

- Добавлять общие методы и поля в реестр которые пользователь использует
...
В системе wb-rules пользователь базово знает только имя топика и новое
значение записанное в топик.
...
Пример самого простого плагина приведен ниже:
