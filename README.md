...
- [ПИД-регулятор (аналоговые выходы)](scenarios/pid-controller/README.md)
...
Перед отправкой PR ознакомьтесь с [документацией по работе с PR](develop/pull-request-workflow.md).
