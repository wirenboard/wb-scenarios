...
> **Критическое замечание о времени:** Данный сценарий работает, опираясь\
> на **системное время** и **часовой пояс**, установленные в текущий момент\
> на контроллере.
>
> Когда вы указываете время в сценарии - вы указываете его именно в том\
> времени, которое установленно в данный момент на контроллере. Если вы\
> поменяете часовой пояс на контроллере, то обязательно нужно перезапустить\
> wb-rules командой:
>
> ```shell
...
> старый часовой пояс для старых и вновь создаваемых сценариев!

Данный сценарий позволяет автоматически выполнять набор действий по заданному\
расписанию на определенное время. Удобен для автоматизации повторяющихся задач:
